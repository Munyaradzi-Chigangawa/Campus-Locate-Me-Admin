...
class _UploadPlaceState extends State<UploadPlace> {
  ...
  String _date;
  String _timestamp;
  String _helperText = 'Enter paths list to help users to go to the desired destination.';
  ...
  void handleSubmit() async {
    ...
    if(stateSelection == null){
      openDialog(context, 'Select Region First', '');
    }
    else{
    ...
    return Scaffold(
      ...
      body: Form(
            ...
            child: ListView(children: <Widget>[
              ...
              SizedBox(height: 50,),
              Text('Navigation Guide Details', style: TextStyle(
                fontSize: 30, fontWeight: FontWeight.w800
              ),),
              SizedBox(height: 20,),
